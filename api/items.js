...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (req.method === 'GET') {
      ...
      // 2. جلب جميع سطور الفواتير التي تنتمي لمستخدم
      ...
      // 3. تجميع الكميات حسب المادة ونوع الفاتورة
      const qtyMap = {};
      ...
      // 4. إثراء المواد بالحقول المحسوبة
    ...
    if (req.method === 'POST') {
      // ... (بقية دوال POST، PUT، DELETE تبقى كما هي) ...
